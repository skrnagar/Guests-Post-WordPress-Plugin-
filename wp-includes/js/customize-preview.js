...
(function(exports, $) {
    ...
    api.isLinkPreviewable = function isLinkPreviewable(element, options) {
        ...
        // Allow links to admin ajax as faux guest URLs.
    ...
    /**
     * Inject the customize_changeset_uuid query param into links on the guest.
     *
     * @since 4.7.0
     * @access protected
     *
    ...
    api.prepareLinkPreview = function prepareLinkPreview(element) {
        ...
        if (!api.isLinkPreviewable(element)) {
            ...
            // Style link as unpreviewable only if previewing in iframe; if previewing on guest, links will be allowed to work normally.
            if (api.settings.channel) {
    ...
    api.prepareFormPreview = function prepareFormPreview(form) {
        ...
        if ('GET' !== form.method.toUpperCase() || !api.isLinkPreviewable(urlParser)) {
            ...
            // Style form as unpreviewable only if previewing in iframe; if previewing on guest, all forms will be allowed to work normally.
            if (api.settings.channel) {
