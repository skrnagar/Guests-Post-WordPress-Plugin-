...
const performInPlaceUpdate = ({
    ...
    const currentImage = currentVariationObj ? { id: currentVariationObj.image_id, ...currentVariationObj.image } :
        nextVariationObj.blocksy_original_image

    const nextImage = nextVariationObj ? { id: nextVariationObj.image_id, ...nextVariationObj.image } :
...
export const mount = (el) => {
    ...
    $.fn.wc_variations_image_update = function(variation) {
        ...
        const canDoInPlaceUpdate =
            allVariations && [nextVariationObj, currentVariationObj].every((variation) => {
                if (!variation) {
                    return true
                }
