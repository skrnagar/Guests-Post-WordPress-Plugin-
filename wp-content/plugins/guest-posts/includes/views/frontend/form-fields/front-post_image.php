...
$uploader_label = (!empty($field_details['upload_button_label'])) ? $field_details['upload_button_label'] : esc_html__('Upload Image', 'guest-posts-submission');
...
<div class="fpsml-file-preview-wrap">
    ...
    if (!empty($edit_post) && has_post_thumbnail($post_id)) {
        ...
        <div class="fpsml-file-preview-row">
            ...
            <span class="fpsml-file-preview-column"><input type="button" class="fpsml-media-delete-button" data-media-id="<?php echo intval($post_thumbnail_id); ?>" data-media-key="<?php echo esc_attr($attachment_code); ?>" value="<?php esc_attr_e('Delete', 'guest-posts-submission'); ?>"></span>
        </div>
    <?php } ?>
</div>