...
<div class="fpsml-settings-each-section" data-tab="basic">
        ...
        <div class="fpsml-field">
            ...
            <p class="description">
                ...
                if ( !isset( $_GET['form_id'] ) ) {
                    esc_html_e( 'Alias should be unique and shouldn\'t contain any special characters and please use _ instead of space.', 'guest-posts-submission' );
                } else {
                    esc_html_e( 'Alias cannot be modified once added because it is used as the reference for fetching all the details of the form.', 'guest-posts-submission' );
                }
                ?>
            </p>
        </div>
    ...
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e( 'Post Status', 'guest-posts-submission' ); ?></label>
        <div class="fpsml-field">
    ...
    if ( $form_row->form_type == 'guest' ) {
        ?>
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e( 'Post Author', 'guest-posts-submission' ); ?></label>
            <div class="fpsml-field">
    ...
    if ( current_theme_supports( 'post-formats' ) ) {
        ?>
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e( 'Post Format', 'guest-posts-submission' ); ?></label>
            <div class="fpsml-field">
                <select name="form_details[basic][post_format]">
                    ...
                    ?>
                    <option value=""><?php esc_html_e( 'Standard', 'guest-posts-submission' ); ?></option>
                    <?php
                ...
                <p class="description"><?php esc_html_e( 'These are the post formats registered in your current active theme.', 'guest-posts-submission' ); ?></p>
            </div>
        </div>
        <?php
    }
    ?>
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e( 'Validation Error Message', 'guest-posts-submission' ); ?></label>
        <div class="fpsml-field">
            ...
            <p class="description"><?php esc_html_e( 'This message will be shown when any validation error occurs.', 'guest-posts-submission' ); ?></p>
        </div>
    </div>
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e( 'Form Success Message', 'guest-posts-submission' ); ?></label>
        <div class="fpsml-field">
            ...
            <p class="description"><?php esc_html_e( 'This message will be shown after successful form submission', 'guest-posts-submission' ); ?></p>
        </div>
    </div>

    <div class="fpsml-field-wrap">
        <label><?php esc_html_e( 'Post Submit Redirection', 'guest-posts-submission' ); ?></label>
        <div class="fpsml-field">
            ...
            <p class="description"><?php esc_html_e( 'Please check if you want to enable redirection after post submission.', 'guest-posts-submission' ); ?></p>
        </div>
    </div>
    <div class="fpsml-redirection-type <?php echo (empty( $basic_settings['redirection'] )) ? 'fpsml-display-none' : ''; ?>" >
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e( 'Redirection Type', 'guest-posts-submission' ); ?></label>
            <div class="fpsml-field">
                <?php
                ...
                <select name="form_details[basic][redirection_type]" class="fpsml-toggle-trigger" data-toggle-class="fpsml-redirection-url">
                    <option value="url" <?php selected( $selected_redirection_type, 'url' ); ?>><?php esc_html_e( 'URL', 'guest-posts-submission' ); ?></option>
                    <option value="published_post" <?php selected( $selected_redirection_type, 'published_post' ); ?>><?php esc_html_e( 'Published Post', 'guest-posts-submission' ); ?></option>
                </select>
            </div>
        </div>
        <div class="fpsml-field-wrap fpsml-redirection-url <?php echo ($selected_redirection_type != 'url') ? 'fpsml-display-none' : ''; ?>" data-toggle-ref="url">
            <label><?php esc_html_e( 'Redirection URL', 'guest-posts-submission' ); ?></label>
            <div class="fpsml-field">
    ...
    <?php if ( $form_row->form_type == 'login_require' ) { ?>
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e( 'Post Edit Redirection', 'guest-posts-submission' ); ?></label>
            <div class="fpsml-field">
                ...
                <p class="description"><?php esc_html_e( 'Please check if you want to enable redirection after post edit.', 'guest-posts-submission' ); ?></p>
            </div>
        </div>
        <div class="fpsml-field-wrap fpsml-edit-redirection <?php echo (empty( $basic_settings['edit_redirection'] )) ? 'fpsml-display-none' : ''; ?>" >
            <label><?php esc_html_e( 'Edit Redirection URL', 'guest-posts-submission' ); ?></label>
            <div class="fpsml-field">
