<div class="fpsml-each-form-field">
    <div class="fpsml-field-head fpsml-clearfix">
        <h3 class="fpsml-field-title"><span class="dashicons dashicons-arrow-down"></span><?php esc_html_e( 'Post Content', 'guest-posts-submission' ); ?></h3>
    </div>
    <div class="fpsml-field-body fpsml-display-none">
        ...
        <div class="fpsml-show-fields-ref-<?php echo esc_attr( $field_key ); ?> <?php echo (empty( $field_details['show_on_form'] )) ? 'fpsml-display-none' : ''; ?>">
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e( 'Editor Type', 'guest-posts-submission' ); ?></label>
                <div class="fpsml-field">
                    ...
                    <select name="<?php echo esc_attr( $field_name_prefix ); ?>[editor_type]" class="fpsml-editor-type">
                        <option value="simple" <?php selected( $editor_type, 'simple' ); ?>><?php esc_html_e( 'Simple Textarea', 'guest-posts-submission' ); ?></option>
                        <option value="rich" <?php selected( $editor_type, 'rich' ); ?>><?php esc_html_e( 'Rich Text Editor', 'guest-posts-submission' ); ?></option>
                        <option value="visual" <?php selected( $editor_type, 'visual' ); ?>><?php esc_html_e( 'Visual Text Editor', 'guest-posts-submission' ); ?></option>
                        <option value="html" <?php selected( $editor_type, 'html' ); ?>><?php esc_html_e( 'HTML Text Editor', 'guest-posts-submission' ); ?></option>
                    </select>
                </div>
            </div>
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e( 'Editor Height', 'guest-posts-submission' ); ?></label>
                <div class="fpsml-field">
                    ...
                    <p class="description"><?php esc_html_e( 'Please enter the height of the editor in px if you want to increase or decrease the default height.', 'guest-posts-submission' ); ?></p>
                </div>
            </div>
            <?php
            ...
            if ( $form_row->form_type == 'login_require' ) {
                ...
                <div class="fpsml-field-wrap fpsml-editor-type-ref <?php echo (!in_array( $editor_type, $media_ref_editors )) ? 'fpsml-display-none' : '' ?>">
                    <label><?php esc_html_e( 'Media Upload', 'guest-posts-submission' ); ?></label>
                    <div class="fpsml-field">
            ...
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e( 'Character Limit', 'guest-posts-submission' ); ?></label>
                <div class="fpsml-field">
