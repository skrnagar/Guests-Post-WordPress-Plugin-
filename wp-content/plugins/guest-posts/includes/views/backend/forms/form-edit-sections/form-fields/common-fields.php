<div class="fpsml-field-wrap">
    <label><?php esc_html_e('Show on form', 'guest-posts-submission'); ?></label>
...
<div class="fpsml-show-fields-ref-<?php echo (!empty($show_hide_toggle_class)) ? esc_attr($show_hide_toggle_class) : esc_attr($field_key); ?> <?php echo (empty($field_details['show_on_form'])) ? 'fpsml-display-none' : ''; ?>">
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Required', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
    ...
    <div class="fpsml-field-wrap fpsml-required-message <?php echo (empty($field_details['required'])) ? 'fpsml-display-none' : ''; ?>">
        <label><?php esc_html_e('Required Error Message', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
    ...
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Field Label', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
    ...
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Field Note', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
            ...
            <p class="description"><?php esc_html_e('This note will show just below the field. Pleaes leave blank if you don\'t want to display the field note.', 'guest-posts-submission'); ?></p>
        </div>
    </div>
</div>