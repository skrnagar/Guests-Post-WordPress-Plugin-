    ...
    <div class="fpsml-field-body fpsml-display-none">
        ...
        <div class="fpsml-show-fields-ref-<?php echo esc_attr($taxonomy); ?> <?php echo (empty($field_details['show_on_form'])) ? 'fpsml-display-none' : ''; ?>">
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('Field Type', 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
                    <select name="<?php echo esc_attr($field_name_prefix) ?>[field_type]" class="fpsml-toggle-trigger" data-toggle-class='fpsml-taxonomy-field-type-ref'>
                        ...
                        ?>
                        <option value="select" <?php selected($field_type, 'select'); ?>><?php esc_html_e('Select Dropdown', 'guest-posts-submission'); ?></option>
                        <option value="checkbox" <?php selected($field_type, 'checkbox'); ?>><?php esc_html_e('Checkbox', 'guest-posts-submission'); ?></option>
                        <?php
                        if ($taxonomy_details->hierarchical == 0) {
                            ?>
                            <option value="textfield" <?php selected($field_type, 'textfield'); ?>><?php esc_html_e('Textfield', 'guest-posts-submission'); ?></option>
                            <?php
                        }
                        ?>
                    </select>
            ...
            <div class="fpsml-field-wrap fpsml-taxonomy-field-type-ref" <?php echo $fpsml_library_obj->display_none($field_type, 'select'); ?> data-toggle-ref="select">
                <label><?php esc_html_e('First Option Label', 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
            ...
            <div class="fpsml-field-wrap fpsml-taxonomy-field-type-ref" <?php echo $fpsml_library_obj->display_none($field_type, 'select'); ?> data-toggle-ref="select">
                <label><?php esc_html_e('Multiple', 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
                    ...
                    <p class="description"><?php esc_html_e(sprintf('Please check if you want to enable mutiple %s selection', $taxonomy_details->label), 'guest-posts-submission'); ?></p>
                </div>
            </div>
            <div class="fpsml-field-wrap fpsml-taxonomy-field-type-ref" <?php echo $fpsml_library_obj->display_none($field_type, 'checkbox'); ?> data-toggle-ref='checkbox'>
                <label><?php esc_html_e('Display Type', 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
                    <select name="<?php echo esc_attr($field_name_prefix) ?>[display_type]">
                        ...
                        ?>
                        <option value="inline" <?php selected($display_type, 'inline'); ?>><?php esc_html_e('Inline', 'guest-posts-submission'); ?></option>
                        <option value="block" <?php selected($display_type, 'block'); ?>><?php esc_html_e('Block', 'guest-posts-submission'); ?></option>
                    </select>
                </div>
            </div>
            <?php
            if ($taxonomy_details->hierarchical == 0) {
                ...
                <div class="fpsml-field-wrap fpsml-taxonomy-field-type-ref" <?php echo $fpsml_library_obj->display_none($field_type, 'textfield'); ?> data-toggle-ref='textfield'>
                    <label><?php esc_html_e('Auto Complete', 'guest-posts-submission'); ?></label>
                    <div class="fpsml-field">
                ...
                ?>
                <div class="fpsml-field-wrap">
                    <label><?php esc_html_e(sprintf('Display Child %s of ', $taxonomy_details->label), 'guest-posts-submission'); ?></label>
                    <div class="fpsml-field">
                        <select name="<?php echo esc_attr($field_name_prefix) ?>[child_of]">
                            <option value=""><?php _e('None', 'guest-posts-submission'); ?></option>
                            <?php
            ...
            <?php } ?>
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e(sprintf('Exclude %s', $taxonomy_details->label), 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
                    ...
                    <p class="description"><?php esc_html_e(sprintf('Please enter the slug of the %s separated by comma(,) which you want to exclude from displaying.', $taxonomy_details->label), 'guest-posts-submission'); ?></p>
                </div>
            </div>
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e(sprintf('Auto assign %s ', $taxonomy_details->label), 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
                    ...
                    <p class="description"><?php esc_html_e(sprintf('Please choose the %s that you want to assign explicitly. Please use control or command key to select multiple options.', $taxonomy_details->label), 'guest-posts-submission'); ?></p>
                </div>
            </div>
        </div>
    </div>
