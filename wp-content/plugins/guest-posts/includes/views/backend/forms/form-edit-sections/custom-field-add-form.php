<div class="fpsml-custom-field-add-form">
    <h3><?php esc_html_e('Custom Field', 'guest-posts-submission'); ?></h3>
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Label', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
            <input type="text" id="fpsml-custom-field-label"/>
        </div>
    </div>
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Meta Key', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
            <input type="text" id="fpsml-custom-field-meta-key"/>
            <p class="description"><?php esc_html_e('Please use plain text without any special characters for meta key and use underscore(_) instead of white space.', 'guest-posts-submission'); ?></p>
        </div>
    </div>
    <div class="fpsml-field-wrap">
    ...
    <div class="fpsml-field-wrap">
        <div class="fpsml-field">
            <input type="button" class="fpsml-button-secondary fpsml-custom-field-add-trigger" value="<?php esc_attr_e('Add', 'guest-posts-submission'); ?>"/>
        </div>
