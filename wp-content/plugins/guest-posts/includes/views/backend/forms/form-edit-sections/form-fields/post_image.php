<div class="fpsml-each-form-field">
    <div class="fpsml-field-head fpsml-clearfix">
        <h3 class="fpsml-field-title"><span class="dashicons dashicons-arrow-down"></span><?php esc_html_e('Post Image', 'guest-posts-submission'); ?></h3>
    </div>
    <div class="fpsml-field-body fpsml-display-none">
        ...
        <div class="fpsml-show-fields-ref-<?php echo esc_attr($field_key); ?> <?php echo (empty($field_details['show_on_form'])) ? 'fpsml-display-none' : ''; ?>">
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('Upload Button Label', 'guest-posts-submission'); ?></label>
            ...
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('File Extension Error Message', 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
                    ...
                    <p class="description"><?php esc_html_e('Please use {file} and {extensions} to replace uploaded file name and allowed extension in the displayed message. For example: {file} has invalid extension. Only {extensions} are allowed.', 'guest-posts-submission'); ?></p>
                </div>
            </div>
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('Upload File Size Limit', 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
                    ...
                    <p class="description"><?php esc_html_e('Please enter the max size of the file being uploaded in MB. Default is 5 MB.', 'guest-posts-submission'); ?></p>
                    <?php
                    $max_upload_filesize = ini_get('upload_max_filesize');
                    ?>
                    <p class="description"><?php esc_html_e(sprintf("Please note that the number shouldn't exceed %s. If you want to allow more than %s then please update the value in your server's php.ini file.", $max_upload_filesize, $max_upload_filesize), 'guest-posts-submission'); ?></p>
                </div>
            </div>
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('Max Size Error Message', 'guest-posts-submission'); ?></label>
                <div class="fpsml-field">
