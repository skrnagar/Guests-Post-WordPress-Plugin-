<div class="fpsml-settings-each-section fpsml-display-none" data-tab="notification">
    <div class="fpsml-each-form-field">
        <div class="fpsml-field-head fpsml-clearfix">
            <h3 class="fpsml-field-title"><span class="dashicons dashicons-arrow-down"></span><?php esc_html_e('Admin Notification', 'guest-posts-submission'); ?></h3>
        </div>
        <div class="fpsml-field-body fpsml-display-none">
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('Enable', 'guest-posts-submission'); ?></label>
            ...
            <div class="fpsml-show-fields-ref-admin-notification <?php echo (empty($form_details['notification']['admin']['enable'])) ? 'fpsml-display-none' : ''; ?>">
                <div class="fpsml-field-wrap">
                    <label><?php esc_html_e('Notification Emails', 'guest-posts-submission'); ?></label>
                    <div class="fpsml-field fpsml-checkbox-toggle">
                        ...
                        <p class="description"><?php esc_html_e('Please enter the emails in which you want to receive notifications separated by comma. If kept blank, it will go to admin email.', 'guest-posts-submission'); ?></p>
                    </div>
                </div>
                <div class="fpsml-field-wrap">
                    <label><?php esc_html_e('Subject', 'guest-posts-submission'); ?></label>
                    <div class="fpsml-field fpsml-checkbox-toggle">
                        ...
                        <p class="description"><?php esc_html_e('You can use [post_title] and [author_name] to replace it with submitted post title and author name in the subject while receiving the post admin notification.', 'guest-posts-submission'); ?></p>
                    </div>
                </div>
                <div class="fpsml-field-wrap fpsml-required-message ">
                    <label><?php esc_html_e('From name', 'guest-posts-submission'); ?></label>
                    <div class="fpsml-field">
                ...
                <div class="fpsml-field-wrap">
                    <label><?php esc_html_e('From Email', 'guest-posts-submission'); ?></label>
                    <div class="fpsml-field">
                ...
                <div class="fpsml-field-wrap">
                    <label><?php esc_html_e('Message', 'guest-posts-submission'); ?></label>
                    <div class="fpsml-field">
                        ...
                        <p class="description"><?php esc_html_e('Please use [post_title],[post_admin_link] to replace it with the submitted post title and post admin link in the post submission admin notification email message.', 'guest-posts-submission'); ?></p>
                    </div>
                </div>
            </div>
    ...
    <div class="fpsml-each-form-field">
        <div class="fpsml-field-head fpsml-clearfix">
            <h3 class="fpsml-field-title"><span class="dashicons dashicons-arrow-down"></span><?php esc_html_e('Post Publish Notification', 'guest-posts-submission'); ?></h3>
        </div>
        <div class="fpsml-field-body fpsml-display-none">
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('Enable', 'guest-posts-submission'); ?></label>
            ...
            <div class="fpsml-show-fields-ref-post-notification <?php echo (empty($form_details['notification']['post_publish']['enable'])) ? 'fpsml-display-none' : ''; ?>">
                <div class="fpsml-field-wrap">
                    ...
                    <div class="fpsml-field fpsml-checkbox-toggle">
                        ...
                        <p class="description"><?php esc_html_e('You can use [post_title] and [author_name] to replace it with submitted post title and author name in the subject while sending the post publish notification.', 'guest-posts-submission'); ?></p>
                    </div>
                </div>
                <div class="fpsml-field-wrap fpsml-required-message ">
                    <label><?php esc_html_e('From name', 'guest-posts-submission'); ?></label>
                ...
                <div class="fpsml-field-wrap">
                    ...
                    <div class="fpsml-field">
                        ...
                        <p class="description"><?php esc_html_e('Please use [author_name],[post_title],[post_link] to replace with the approved post\'s author name, post title and post frontend link in the post publish email message.', 'guest-posts-submission'); ?></p>
                    </div>
                </div>
            </div>
