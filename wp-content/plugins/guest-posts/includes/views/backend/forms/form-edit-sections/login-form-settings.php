...
<div class="fpsml-settings-each-section fpsml-display-none fpsml-clearfix" data-tab="login">
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Login Type', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
            <select name="form_details[login][login_type]" class="fpsml-toggle-trigger" data-toggle-class="fpsml-login-type-ref">
                ...
                ?>
                <option value="login_form" <?php selected($selected_login_type, 'login_form'); ?>><?php esc_html_e('Show Login Form', 'guest-posts-submission'); ?></option>
                <option value="login_message" <?php selected($selected_login_type, 'login_message'); ?>><?php esc_html_e('Show Login Message', 'guest-posts-submission'); ?></option>
                <option value="login_page_redirect" <?php selected($selected_login_type, 'login_page_redirect'); ?>><?php esc_html_e('Redirect to Login Page', 'guest-posts-submission'); ?></option>
            </select>
        </div>
    </div>
    <div class="fpsml-login-type-ref <?php echo ($selected_login_type != 'login_form') ? 'fpsml-display-none' : ''; ?>" data-toggle-ref="login_form">
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login Form Title', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Username Label', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Password Label', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Show Remember Me', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap fpsml-remember-me-label <?php echo (empty($login_form_settings['show_remember_me'])) ? 'fpsml-display-none' : ''; ?>">
            <label><?php esc_html_e('Remember Me Label', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login Button Label', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login Note', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login error message', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
    ...
    <div class="fpsml-login-type-ref <?php echo ($selected_login_type != 'login_message') ? 'fpsml-display-none' : ''; ?>" data-toggle-ref="login_message">
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login Message', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login Link Label', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
        ...
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login Link URL', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
    ...
    <div class="fpsml-login-type-ref <?php echo ($selected_login_type != 'login_page_redirect') ? 'fpsml-display-none' : ''; ?>" data-toggle-ref="login_page_redirect">
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Login Page URL', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
                ...
                <p class="description"><?php esc_html_e('Please enter the URL in which you want to redirect users when they are not logged in.', 'guest-posts-submission'); ?></p>
            </div>
        </div>
    </div>
</div>
