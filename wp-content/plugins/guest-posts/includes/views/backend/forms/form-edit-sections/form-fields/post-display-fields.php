<div class="fpsml-show-fields-ref-<?php echo (!empty($show_hide_toggle_class)) ? esc_attr($show_hide_toggle_class) : esc_attr($field_key); ?> <?php echo (empty($field_details['show_on_form'])) ? 'fpsml-display-none' : ''; ?>">
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Post Detail Display', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
            ...
            <p class="description"><?php esc_html_e('Please check if you want to display this field received value in the frontend post detail page.', 'guest-posts-submission'); ?></p>
        </div>
    </div>
    <div class="fpsml-post-detail-display-ref-<?php echo esc_attr($show_hide_toggle_class); ?> <?php echo (empty($field_details['post_detail_display'])) ? 'fpsml-display-none' : ''; ?>">
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Display Position', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
                <select name="<?php echo esc_attr($field_name_prefix) ?>[display_position]">
                    ...
                    ?>
                    <option value="after_content" <?php selected($selected_display_position, 'after_content'); ?>><?php esc_html_e('After Content', 'guest-posts-submission'); ?></option>
                    <option value="before_content" <?php selected($selected_display_position, 'before_content'); ?>><?php esc_html_e('Before Content', 'guest-posts-submission'); ?></option>
                </select>

            </div>
        </div>
        <div class="fpsml-field-wrap">
            <label><?php esc_html_e('Display Label', 'guest-posts-submission'); ?></label>
            <div class="fpsml-field">
