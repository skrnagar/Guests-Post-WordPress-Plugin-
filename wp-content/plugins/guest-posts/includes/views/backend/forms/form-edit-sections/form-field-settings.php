...
<div class="fpsml-settings-each-section fpsml-display-none fpsml-clearfix" data-tab="form">
    <div class="fpsml-form-fields-wrap ">
        <div class="fpsml-form-fields-list">
            <h3 class="fpsml-form-settings-heading"><?php esc_html_e('Form Fields', 'guest-posts-submission'); ?></h3>
        ...
        <div class="fpsml-form-other-settings">
            <h3 class="fpsml-form-settings-heading"><?php esc_html_e('Other Settings', 'guest-posts-submission'); ?></h3>
            <div class="fpsml-field-wrap">
                <label><?php esc_html_e('Submit Button Label', 'guest-posts-submission'); ?></label>
