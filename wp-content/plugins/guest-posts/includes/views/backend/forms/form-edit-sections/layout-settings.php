...
<div class="fpsml-settings-each-section fpsml-display-none" data-tab="layout">
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Form Template', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
            <select name="form_details[layout][template]" class="fpsml-form-template">
                ...
                for ($i = 1; $i <= 5; $i++) {
                    ?>
                    <option value="template-<?php echo intval($i); ?>" <?php selected($selected_template, 'template-' . $i); ?>><?php esc_html_e(sprintf('Template %d', $i), 'guest-posts-submission'); ?></option>
                    <?php
                }
                ?>
            </select>
    ...
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Custom Fields Display Template', 'guest-posts-submission'); ?></label>
        <div class="fpsml-field">
