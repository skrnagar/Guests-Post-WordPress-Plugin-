    ...
    class FPSML_Shortcode {
        ...
        function register_frontend_assets() {
            ...
            $translation_strings = array(
                ...
                'typeError' => esc_html__("{file} has invalid extension. Only {extensions} are allowed.", 'guest-posts-submission'),
                'sizeError' => esc_html__("{file} is too large, maximum file size is {sizeLimit}.", 'guest-posts-submission'),
                'minSizeError' => esc_html__("{file} is too small, minimum file size is {minSizeLimit}.", 'guest-posts-submission'),
                'emptyError' => esc_html__("{file} is empty, please select files again without it.", 'guest-posts-submission'),
                'onLeave' => esc_html__("The files are being uploaded, if you leave now the upload will be cancelled.", 'guest-posts-submission')
            );
            $js_obj = array(
        ...
        function output_form_shortcode($atts) {
            if (!empty($atts['alias'])) {
                ...
                if (!empty($form_row)) {
                    ...
                    return esc_html__('Form not available for this alias.', 'guest-posts-submission');
                }
            }
        }
