...
if (!class_exists('FPSML_Activation')) {
    ...
    class FPSML_Activation {
        ...
        function __construct() {
            ...
            register_activation_hook(FPSML_PATH . '/guest-posts-submission.php', array($this, 'activation_tasks'));
        }
        ...
        function insert_default_forms($form_table) {
             ...
             */
            $form_title = esc_html__('Login Require Form', 'guest-posts-submission');
             ...
             */
            $form_title = esc_html__('Guest Post Form', 'guest-posts-submission');
