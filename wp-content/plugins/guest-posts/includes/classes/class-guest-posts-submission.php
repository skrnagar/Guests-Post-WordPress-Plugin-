...
if (!class_exists('Guest_Posts_Submission')) {
    ...
    class Guest_Posts_Submission {
         ...
         * @since 1.0.0
         * @static
         * @return Guest_Posts_Submission - Main instance.
         */
        ...
        public function __clone() {
            ...
            _doing_it_wrong(__FUNCTION__, esc_html__('No script kiddies please!!', 'guest-posts-submission'), '1.6');
        }
        ...
        function define_constants() {
            ...
            $custom_field_type_list = array(
                'textfield' => array('label' => esc_html__('Texfield', 'guest-posts-submission'), 'icon' => 'fas fa-edit'),
                'textarea' => array('label' => esc_html__('Textarea', 'guest-posts-submission'), 'icon' => 'fas fa-expand'),
            );
            /**
