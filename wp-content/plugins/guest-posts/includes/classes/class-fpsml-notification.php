...
if (!class_exists('FPSML_Notification')) {
    ...
    class FPSML_Notification {
        ...
        function trigger_post_reject_notifications($post_id) {
            ...
            $from_name = (!empty($form_details['notification']['post_trash']['from_name'])) ? $form_details['notification']['post_trash']['from_name'] : esc_html__('No Reply', 'guest-posts-submission');
        ...
        function trigger_post_publish_notification($new_status, $old_status, $post) {
            if (!(defined('REST_REQUEST') && REST_REQUEST )) {
                ...
                $from_name = (!empty($form_details['notification']['post_publish']['from_name'])) ? $form_details['notification']['post_publish']['from_name'] : esc_html__('No Reply', 'guest-posts-submission');
