...
if (!empty($fpsml_form_alias)) {
    ...
    <div class="fpsml-field-wrap">
        <label><?php esc_html_e('Frontend Form', 'guest-posts-submission'); ?></label>
                            ...
                            case 'datepicker':
                                ...
                                <div class="fpsml-date-picker">
                                    ...
                                    if (empty($field_details['string_format'])) {
                                        ...
                                        ?>
                                        <input type="text" name="<?php echo esc_attr($custom_field_name); ?>" value="<?php echo esc_attr($custom_field_value); ?>"/>
                                        <p class="description"><?php esc_html_e('Note: Date is showing up in the string format because you had enabled the string format option.', 'guest-posts-submission'); ?></p>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    if (!empty($custom_field_value)) {
                                        ...
                                        foreach ($media_ids as $media_id) {
                                            ...
                                            <div class="fpsml-file-preview-row">
                                                ...
                                                <span class="fpsml-file-preview-column"><input type="button" class="fpsml-media-remove-button" data-media-id='<?php echo intval($media_id); ?>' value="<?php esc_html_e('Remove', 'guest-posts-submission'); ?>"/></span>
                                            </div>
                                            <?php
                                        }
                                    }
